#!/usr/bin/python3
"""Contains unittest for models/place.py.
...
class TestPlace_instantiation(unittest.TestCase):
    """Unittest for testing instantiation of Place class."""
...
class TestPlace_save(unittest.TestCase):
    """Unittest for testing save method of Place class."""
...
class TestPlace_to_dict(unittest.TestCase):
    """Unittest for testing to_dict method of Place class."""
